...
namespace BarbezDotEu.String
{
    ...
    public static class StringConstants
    {
        ...
        /// </summary>
        public const string FileNameCompatibleDateTime = @"yyyyMMddHmmssfffffff";
        ...
        /// A constant for "gzip".
        /// </summary>
        public const string AcceptEncodingGzip = @"gzip";

        internal const int UniqueStringMaxCharacterCount = 450;
    }
}
